 ...
 * Use the [ChartSwipeFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChartSwipeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        val adapter = PageChartSwipeAdapter(fragmentManager,inputData)
    ...
    companion object {
         ...
         * @return A new instance of fragment ChartSwipeFragment.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): ChartSwipeFragment {
            val fragment = ChartSwipeFragment()
            val args = Bundle()
